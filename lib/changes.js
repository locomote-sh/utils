...
/* Test input for above:
console.log(correctExtendedChars('"_assets/1200px-Microsoft_Office_Word_(2013\\342\\200\\223present).svg.png"'));
console.log(correctExtendedChars('"Fair PLe Oct 27 RO w Bl\\303\\241thnaid.docx"'));
*/
